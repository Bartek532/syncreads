...
export const Grid = () => {
  ...
  return (
    <div className="flex w-full items-center justify-center">
      <div className="fixed left-1/2 top-3 z-50 grid -translate-x-1/2 grid-cols-3 items-center justify-items-center rounded-3xl bg-background px-4 py-1 shadow-xl">
      ...
      {isImageOpen ? (
        <ThemedImage
          ...
          alt=""
          className="mt-16 w-full rounded-lg"
          width={2717}
          height={2038}
        />
      ) : (
        <div className="mt-16 grid w-full max-w-xl grid-cols-2 gap-3 rounded-xl bg-muted p-3 md:max-w-full md:grid-cols-4 md:gap-4 md:p-4 lg:gap-5 lg:p-5 [&>*]:rounded-xl [&>*]:bg-background">
