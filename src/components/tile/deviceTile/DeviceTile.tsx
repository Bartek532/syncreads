...
export const DeviceTile = memo<DeviceTileProps>(({ device, onDelete }) => {
  return (
    <div className="relative flex gap-10 rounded-2xl bg-white py-6 px-8 shadow dark:bg-slate-800 lg:p-8 xl:p-12">
      ...
      <div className="flex flex-col items-start justify-between py-6 sm:p-10">
        <h2 className="text-2xl font-medium leading-4 text-gray-900 dark:text-white sm:text-4xl">
          reMarkable 2
        </h2>
        <div className="mt-6 flex flex-col lg:gap-0.5">
          <span className="text-base text-gray-500 dark:text-slate-300 lg:text-lg">
            Registered at
          </span>
